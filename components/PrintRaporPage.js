...
const ReportHeader = ({ settings }) => {
    ...
    return (
        React.createElement('div', { className: "absolute top-0 left-0 right-0", style: { height: '5.2cm', padding: '1.5cm 1.5cm 0 1.5cm' } },
...
const CoverPage = ({ student, settings }) => {
    ...
    return React.createElement('div', { 
            className: 'h-full flex flex-col items-center text-center report-cover-border',
            style: { padding: '1.5cm', boxSizing: 'border-box' } 
        },
        React.createElement('div', { className: 'w-full pt-8' },
            ...
            React.createElement('div', { className: 'mt-24 w-full max-w-lg mx-auto' },
