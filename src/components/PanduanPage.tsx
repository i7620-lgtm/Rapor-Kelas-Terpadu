...
const PanduanPage = ({ setActivePage }) => {
            ...
            content: (
                React.createElement(React.Fragment, null,
                    ...
                    React.createElement('ol', { className: "list-decimal pl-5 space-y-1 text-zinc-600" },
                        React.createElement('li', null, "Buka menu ", React.createElement('button', { onClick: () => setActivePage('PENGATURAN'), className: "text-indigo-600 hover:underline font-medium" }, "Pengaturan"), "."),
        ...
        },
        {
                ...
                React.createElement('div', { className: "w-full h-full bg-white rounded-lg shadow-sm border border-slate-200 p-4 flex flex-col" },
                    React.createElement('div', { className: "flex justify-between items-center mb-4" },
                        ...
                        React.createElement('div', { className: "relative" },
                            React.createElement('div', { className: "px-3 py-1.5 bg-indigo-600 rounded-lg text-white text-[10px] flex items-center font-medium shadow-sm" }, "+ Tambah Siswa Baru"),
            ...
            content: (
                React.createElement(React.Fragment, null,
                    ...
                    React.createElement('ol', { className: "list-decimal pl-5 space-y-1 text-zinc-600" },
                        React.createElement('li', null, "Buka menu ", React.createElement('button', { onClick: () => setActivePage('DATA_SISWA'), className: "text-indigo-600 hover:underline font-medium" }, "Data Siswa"), "."),
        ...
        },
        {
            ...
            content: (
                React.createElement(React.Fragment, null,
                    ...
                    React.createElement('ol', { className: "list-decimal pl-5 space-y-1 text-zinc-600" },
                        React.createElement('li', null, "Buka menu ", React.createElement('button', { onClick: () => setActivePage('DATA_NILAI'), className: "text-indigo-600 hover:underline font-medium" }, "Data Nilai"), "."),
        ...
        },
        {
            ...
            content: (
                React.createElement(React.Fragment, null,
                    ...
                    React.createElement('ol', { className: "list-decimal pl-5 space-y-1 text-zinc-600" },
                        React.createElement('li', null, "Buka menu ", React.createElement('button', { onClick: () => setActivePage('DATA_KOKURIKULER'), className: "text-indigo-600 hover:underline font-medium" }, "Data Kokurikuler"), "."),
                ...
                React.createElement(React.Fragment, null,
                    ...
                    React.createElement('ul', { className: "list-disc pl-5 space-y-2 text-zinc-600" },
                        React.createElement('li', null, 
                            React.createElement('strong', null, "Data Ekstrakurikuler:"), " Buka menu ", React.createElement('button', { onClick: () => setActivePage('DATA_EKSTRAKURIKULER'), className: "text-indigo-600 hover:underline font-medium" }, "Data Ekstrakurikuler"), " untuk memilih kegiatan ekskul yang diikuti tiap siswa beserta predikat dan deskripsinya."
                        ),
                        React.createElement('li', null, 
                            React.createElement('strong', null, "Data Absensi:"), " Buka menu ", React.createElement('button', { onClick: () => setActivePage('DATA_ABSENSI'), className: "text-indigo-600 hover:underline font-medium" }, "Data Absensi"), " untuk merekap jumlah hari Sakit, Izin, dan Tanpa Keterangan (Alpa)."
                        ),
                        React.createElement('li', null, 
                            React.createElement('strong', null, "Catatan Wali Kelas:"), " Buka menu ", React.createElement('button', { onClick: () => setActivePage('CATATAN_WALI_KELAS'), className: "text-indigo-600 hover:underline font-medium" }, "Catatan Wali Kelas"), ". Anda bisa mengetik manual, copy-paste dari Excel, atau menggunakan tombol ", React.createElement('strong', null, "\"Buat Catatan Otomatis\""), " yang akan men-generate kalimat berdasarkan peringkat dan nilai siswa."
                        )
                    )
                )
            )
        },
        {
            ...
            mockup: (
                React.createElement('div', { className: "w-full h-full bg-white rounded-lg shadow-sm border border-slate-200 p-4 flex flex-col" },
                    React.createElement('div', { className: "flex justify-between items-center mb-4" },
                        ...
                        React.createElement('div', { className: "relative" },
                            React.createElement('div', { className: "px-3 py-1.5 bg-indigo-600 rounded-lg text-white text-[10px] flex items-center font-medium shadow-sm" }, "+ Tambah Jurnal"),
                            React.createElement(Pointer, { className: "-top-6 -left-2 scale-75", text: "Klik Tambah" })
                        )
                    ),
            ...
            content: (
                React.createElement(React.Fragment, null,
                    ...
                    React.createElement('ul', { className: "list-disc pl-5 space-y-1 text-zinc-600" },
                        React.createElement('li', null, "Buka menu ", React.createElement('button', { onClick: () => setActivePage('JURNAL_FORMATIF'), className: "text-indigo-600 hover:underline font-medium" }, "Jurnal Formatif"), "."),
        ...
        },
        {
            ...
            content: (
                React.createElement(React.Fragment, null,
                    ...
                    React.createElement('ul', { className: "list-disc pl-5 space-y-2 text-zinc-600" },
                        React.createElement('li', null, 
                            React.createElement('strong', null, "Print Rapor:"), " Buka menu ", React.createElement('button', { onClick: () => setActivePage('PRINT_RAPOR'), className: "text-indigo-600 hover:underline font-medium" }, "Print Rapor"), ". Pilih siswa, pilih halaman yang ingin dicetak (Sampul, Identitas, atau Nilai), atur ukuran kertas (A4/F4), lalu klik tombol Cetak."
                        ),
                        React.createElement('li', null, 
                            React.createElement('strong', null, "Print Piagam:"), " Buka menu ", React.createElement('button', { onClick: () => setActivePage('PRINT_PIAGAM'), className: "text-indigo-600 hover:underline font-medium" }, "Print Piagam"), " untuk mencetak penghargaan bagi siswa berprestasi."
                        ),
                        React.createElement('li', null, 
                            React.createElement('strong', null, "Print Leger:"), " Buka menu ", React.createElement('button', { onClick: () => setActivePage('PRINT_LEGER'), className: "text-indigo-600 hover:underline font-medium" }, "Print Leger"), " untuk mencetak rekapitulasi nilai seluruh siswa dalam satu kelas."
                        )
                    )
                )
            )
    ...
    return (
        React.createElement('div', { className: "flex flex-col h-full gap-6 max-w-4xl mx-auto pb-10 pt-4 sm:pt-8" },
