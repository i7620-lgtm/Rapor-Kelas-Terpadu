    ...
    const renderContent = () => {
        if (matchedSubject) {
            return React.createElement(React.Fragment, null,
                ...
                React.createElement('p', { className: 'font-bold text-zinc-800' }, matchedSubject.fullName),
                ...
                React.createElement('ul', { className: 'list-disc list-inside pl-4 text-zinc-500 text-sm' },
            ...
            return React.createElement(React.Fragment, null,
                ...
                React.createElement('p', { className: 'mt-2 text-zinc-600' }, 'Aplikasi tidak dapat menentukan mata pelajaran secara otomatis. Silakan pilih mata pelajaran yang benar dari daftar di bawah ini.'),
                ...
                React.createElement('div', { className: "p-6" },
                    React.createElement('div', { className: "flex items-start" },
                        ...
                        React.createElement('div', { className: "ml-4 text-left" },
                            React.createElement('h3', { className: "text-lg leading-6 font-bold text-zinc-900" }, "Konfirmasi Pengisian Data"),
                            React.createElement('div', { className: "mt-2" },
                                React.createElement('div', { className: "text-sm text-zinc-600 space-y-2" }, renderContent())
                            )
                        )
                    )
                ),
                React.createElement('div', { className: "bg-[#fafafa] px-6 py-3 flex flex-row-reverse rounded-b-lg" },
    ...
    return (
        React.createElement(React.Fragment, null,
            ...
            React.createElement('div', { className: "fixed inset-0 bg-black bg-opacity-60 z-[60] flex items-center justify-center p-4", onClick: handleClose },
                React.createElement('div', { className: "bg-white rounded-xl shadow-xl w-full max-w-lg", onClick: e => e.stopPropagation() },
                    React.createElement('div', { className: "p-5 border-b" },
                        React.createElement('h3', { className: "text-xl font-bold text-zinc-800" }, "Isi Format E-Rapor"),
                        React.createElement('p', { className: "text-sm text-zinc-500 mt-1" }, "Unggah format Excel e-Rapor kosong untuk diisi secara otomatis.")
                    ),
                    React.createElement('div', { className: "p-6 space-y-4" },
                        React.createElement('div', { 
                            ...
                            React.createElement('div', { className: "space-y-1 text-center" },
                                ...
                                React.createElement('div', { className: "flex text-sm text-zinc-600" },
                                    React.createElement('label', { htmlFor: "file-upload", className: "relative cursor-pointer bg-transparent rounded-lg font-medium text-zinc-900 hover:text-zinc-500 focus-within:outline-none" },
                                ...
                                React.createElement('p', { className: "text-xs text-zinc-500" }, "XLSX, XLS")
                            )
                        ),
                        fileName && React.createElement('p', { className: "text-sm font-medium text-zinc-700 text-center" }, `File terpilih: ${fileName}`)
                    ),
                    React.createElement('div', { className: "flex justify-end p-4 bg-[#fafafa] rounded-b-lg" },
                        React.createElement('button', { onClick: handleClose, className: "bg-white py-2 px-4 border border-zinc-300/60 rounded-lg text-sm font-medium text-zinc-700 hover:bg-[#fafafa]" }, "Batal"),
                        React.createElement('button', {
