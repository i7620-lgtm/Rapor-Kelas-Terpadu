        ...
        React.createElement('div', { className: "fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4", onClick: handleDeselect },
            ...
            React.createElement('div', { className: "bg-slate-100 rounded-lg shadow-xl w-full max-w-7xl h-[95vh] flex flex-col", onClick: e => e.stopPropagation() },
                ...
                React.createElement('div', { className: "flex flex-col md:flex-row flex-1 overflow-hidden" },
                    ...
                    React.createElement('div', { className: "w-full md:w-72 bg-white p-4 border-t md:border-t-0 md:border-l overflow-y-auto flex-shrink-0" },
...
const FormField = ({ label, id, type = 'text', placeholder = '', value, onChange, onBlur, onKeyDown, className, status, ...props }) => {
...
const SettingsPage = ({ settings, onSettingsChange, onSave, onUpdateKopLayout, subjects, onUpdateSubjects, extracurriculars, onUpdateExtracurriculars, showToast }) => {
    ...
    const getStatus = (value) => value && String(value).trim() !== '' ? 'good' : 'bad';
                        ...
                        React.createElement('section', null,
                            ...
                            React.createElement('div', { className: "grid grid-cols-1 lg:grid-cols-3 gap-x-8 gap-y-4" },
                                React.createElement('div', { className: "lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4" },
                                    ...
                                    React.createElement(FormField, { label: "Nama Sekolah", id: "nama_sekolah", value: settings.nama_sekolah, status: getStatus(settings.nama_sekolah), onChange: onSettingsChange, onBlur: onSave, onKeyDown: handleKeyDown }),
                        ...
                        React.createElement('section', { className: "pt-8 border-t border-slate-200" },
                            React.createElement('div', { className: "grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch" },
                                ...
                                React.createElement('div', { className: "flex flex-col gap-4 h-full" },
                                    ...
                                    React.createElement(FormField, { label: "Tahun Ajaran", id: "tahun_ajaran", placeholder: "e.g. 2023/2024", value: settings.tahun_ajaran, status: getStatus(settings.tahun_ajaran), onChange: onSettingsChange, onBlur: onSave, onKeyDown: handleKeyDown }),
                                    React.createElement('div', null,
                                        ...
                                        React.createElement('select', { 
                                            ...
                                            className: `w-full px-3 py-2 bg-white border rounded-md shadow-sm focus:ring-1 sm:text-sm text-slate-900 ${getStatus(settings.semester) === 'bad' ? 'border-red-500 focus:ring-red-500 focus:border-red-500 ring-1 ring-red-500' : 'border-green-500 focus:ring-green-500 focus:border-green-500 ring-1 ring-green-500'}`
                                        },
                                    ...
                                    React.createElement('table', { className: "w-full text-sm text-left text-slate-500" },
                                        React.createElement('thead', { className: "text-xs text-slate-700 uppercase bg-slate-100" },
                                            React.createElement('tr', null,
                                                React.createElement('th', { className: "px-4 py-3 sm:px-6 sm:py-3 border-b whitespace-nowrap" }, "Mata Pelajaran"),
                                                React.createElement('th', { className: "px-4 py-3 sm:px-6 sm:py-3 border-b whitespace-nowrap" }, "Metode Pengolahan")
                                            )
                                        ),
                                        React.createElement('tbody', null,
                                            subjects.filter(s => s.active).map(sub => (
                                                React.createElement('tr', { key: sub.id, className: "bg-white border-b hover:bg-slate-50" },
                                                    React.createElement('td', { className: "px-4 py-3 sm:px-6 sm:py-4 font-medium text-slate-900 min-w-[150px]" }, sub.fullName),
                                                    React.createElement('td', { className: "px-4 py-3 sm:px-6 sm:py-4" },
                                                        React.createElement('select', {
