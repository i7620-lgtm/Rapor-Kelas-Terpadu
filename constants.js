...
export const studentFieldDefinitions = [
    ...
    { key: 'jenisKelamin', label: 'Jenis Kelamin', description: 'Jenis kelamin siswa (Laki-laki atau Perempuan).', type: 'text'},
    { key: 'agama', label: 'Agama', description: 'Agama atau kepercayaan yang dianut siswa.', type: 'text' },
